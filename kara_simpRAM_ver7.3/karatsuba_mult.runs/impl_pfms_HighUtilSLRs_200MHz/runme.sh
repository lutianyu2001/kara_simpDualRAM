...
HD_PWD='C:/1desktop/karatsuba_mult_opt/karatsuba_mult.runs/impl_pfms_HighUtilSLRs_200MHz'
cd "$HD_PWD"
...
EAStep vivado -log karatsuba_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source karatsuba_top.tcl -notrace
