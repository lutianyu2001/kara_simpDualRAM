...
HD_PWD='C:/1desktop/karatsuba_mult_opt/karatsuba_mult.runs/synth_vivado-default'
cd "$HD_PWD"
...
EAStep vivado -log karatsuba_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source karatsuba_top.tcl
